...
router.get('/shop/category/:categoria', isAuthenticated, isBuyer, appController.listSoftwaresByCategory); //comprasController tem controller para isto
router.get('/shop', isAuthenticated, isBuyer, appController.listAllSoftwares);                     //Dá só categoria 
